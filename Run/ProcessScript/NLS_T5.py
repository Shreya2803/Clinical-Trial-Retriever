...
print(df[['nls_summary', 't5_summary']].head())


# Clean the t5_summary text to avoid parsing issues
...
with open(f"{run_name}_T5_NLS_RETRIEVAL.txt", 'w') as txt_file:
    txt_file.write("\n".join(text_lines) + "\n")

# Save the results to a JSON file
with open(f"{run_name}_T5_NLS_RETRIEVAL.json", 'w') as json_file:
